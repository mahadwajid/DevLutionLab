            ...
            <nav className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-20 h-20 grid grid-cols-2 lg:grid-cols-[1fr_auto_1fr] items-center" aria-label="Primary Navigation">
                ...
                <div className="flex justify-end items-center gap-6">
                    ...
                    <div className="hidden xl:flex items-center gap-4 text-text-muted mr-2">
                        {[{name:"linkedin", href:"https://www.linkedin.com/company/devlutionlab/"}, {name:'facebook', href:'https://www.facebook.com/devlutionlab/'}, {name:'instagram', href:'https://www.instagram.com/devlutionlab/'}].map((social) => (
                            <Link key={social.name} href={social.href} className="hover:text-secondary transition-colors group">
